    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> pWriter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, JpryosBlocks.ALEXANDRITE_BLOCK.get())
                ...
                .unlockedBy("has_alexandrite",
                        inventoryTrigger(ItemPredicate.Builder
                                .item()
                                .of(JpryosItems.ALEXANDRITE.get())
                                .build()))
                .save(pWriter);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, JpryosItems.ALEXANDRITE.get(), 9)
                ...
                .unlockedBy("has_alexandrite_block",
                        inventoryTrigger(ItemPredicate.Builder
                                .item()
                                .of(JpryosBlocks.ALEXANDRITE_BLOCK.get())
                                .build()))
                .save(pWriter);

        nineBlockStorageRecipes(pWriter,
                RecipeCategory.MISC, JpryosItems.RAW_ALEXANDRITE.get(),
                RecipeCategory.MISC, JpryosBlocks.RAW_ALEXANDRITE_BLOCK.get(),
                "jpryosmod:raw_alexandrite", "alexandrite",
                "jpryosmod:raw_alexandrite_block", "alexandrite");
    ...
    protected static void oreCooking(
        ...
        for(ItemLike itemLike: pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemLike),
                    ...
                    .save(pFinishedRecipeConsumer, JpryosMod.MODID + ":" + getItemName(pResult) + pRecipeName + "_" + getItemName(itemLike));
        }
    }
}
